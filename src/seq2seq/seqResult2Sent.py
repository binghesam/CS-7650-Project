...
seq_result = './translated_sentences.txt' # each translation per line
tagging_json = '../detection/diyi2/neutralizing-bias2April13/src/final_result.json' # result from the tagging
clus_id = './biased_token_idx.json' # result from the clustering

output_file = './seq2sentInTesting.txt'
